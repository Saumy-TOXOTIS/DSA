...
ll Rotated_Binary_Search(vll& array,ll n,ll target)
{
    ...
    while(low <= high)
    {
        ...
        //This new conditions checks if none of left or right part is sorted then reducce the searching space
        elif(array[low] == array[mid] && array[mid] == array[high])
        {
            low++;
            high--;
        }
...
TOXOTIS
{
    ...
    d_ll(n) d_ll(k)
    d_llVecArr(a,n)//Rotated Sorted Array and consisting of duplicates
